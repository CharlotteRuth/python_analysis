...
def SMHM_v_distance(tfiles,outfile_base,tfile_base,*halo_nums):
    ...
    cen_v_tau90 = ax1.scatter(objs_pd_comb['mass'][objs_pd_comb['type']=='Central'],objs_pd_comb['Mstar_Mpeak'][objs_pd_comb['type']=='Central'],c = objs_pd_comb['tau90'][objs_pd_comb['type']=='Central'], cmap = cmx, norm = cNorm,edgecolor = 'k', s = markersize*1, linewidths = edgewidth)
    sat_v_tau90 = ax1.scatter(objs_pd_comb['mass'][objs_pd_comb['type']=='Satellite'],objs_pd_comb['Mstar_Mpeak'][objs_pd_comb['type']=='Satellite'],c = objs_pd_comb['tau90'][objs_pd_comb['type']=='Satellite'], cmap = cmx, norm = cNorm, edgecolor = 'k',marker = "*", s = markersize*1.5, linewidths = edgewidth)
    ...
    ax2.scatter(objs_pd_comb['mass'][objs_pd_comb['type']=='Central'],objs_pd_comb['Mstar_Mpeak'][objs_pd_comb['type']=='Central'],c = np.log10(objs_pd_comb['massiveDist'][objs_pd_comb['type']=='Central']), cmap = cmx, norm = cNorm,edgecolor = 'k', s = markersize*1, linewidths = edgewidth)
    ax2.scatter(objs_pd_comb['mass'][objs_pd_comb['type']=='Satellite'],objs_pd_comb['Mstar_Mpeak'][objs_pd_comb['type']=='Satellite'],c = np.log10(objs_pd_comb['massiveDist'][objs_pd_comb['type']=='Satellite']), cmap = cmx, norm = cNorm,edgecolor = 'k',marker = '*', s = markersize*1.5, linewidths = edgewidth)
    ...
    ax2.scatter(objs_pd_comb['Mpeak'][objs_pd_comb['type']=='Central'],objs_pd_comb['Mstar_Mpeak'][objs_pd_comb['type']=='Central']/objs_pd_comb['Mpeak'][objs_pd_comb['type']=='Central'],c = np.log10(objs_pd_comb['massiveDist'][objs_pd_comb['type']=='Central']), cmap = cmx, norm = cNorm,edgecolor = 'k', s = markersize*1, linewidths = edgewidth)    
    ax2.scatter(objs_pd_comb['Mpeak'][objs_pd_comb['type']=='Satellite'],objs_pd_comb['Mstar_Mpeak'][objs_pd_comb['type']=='Satellite']/objs_pd_comb['Mpeak'][objs_pd_comb['type']=='Satellite'],c = np.log10(objs_pd_comb['massiveDist'][objs_pd_comb['type']=='Satellite']), cmap = cmx, norm = cNorm,edgecolor = 'k', marker = "*", s = markersize*1.5, linewidths = edgewidth)
    ...
    ax3.scatter(objs_pd_comb['mass'][objs_pd_comb['type']=='Central'],objs_pd_comb['Mstar_Mpeak'][objs_pd_comb['type']=='Central'] ,edgecolor = 'k',facecolor = 'none', s = markersize*1, linewidths = edgewidth)    
    ax3.scatter(objs_pd_comb['mass'][objs_pd_comb['type']=='Central'],objs_pd_comb['Mstar_Mpeak'][objs_pd_comb['type']=='Central'],c = np.log10(np.array(objs_pd_comb['mHI'][objs_pd_comb['type']=='Central'].tolist())), cmap = cmx, norm = cNorm,edgecolor = 'k', s = markersize*1, linewidths = edgewidth)  
    ax3.scatter(objs_pd_comb['mass'][objs_pd_comb['type']=='Satellite'],objs_pd_comb['Mstar_Mpeak'][objs_pd_comb['type']=='Satellite'] ,edgecolor = 'k',facecolor = 'none',marker = '*', s = markersize*1.5, linewidths = edgewidth)    
    ax3.scatter(objs_pd_comb['mass'][objs_pd_comb['type']=='Satellite'],objs_pd_comb['Mstar_Mpeak'][objs_pd_comb['type']=='Satellite'],c = np.log10(np.array(objs_pd_comb['mHI'][objs_pd_comb['type']=='Satellite'].tolist())), cmap = cmx, norm = cNorm,edgecolor = 'k',marker = '*', s = markersize*1.5, linewidths = edgewidth)  
    ...
    ax3.legend([cen_v_tau90,sat_v_tau90],['Central','Satellite'],scatterpoints = 1,facecolor = 'white',loc = 0,framealpha = 0,frameon = False)
    ...
    ax3.fill_between(read_abunmatch['M200'][read_abunmatch['M200']> 1e9],read_abunmatch['Mstar_low'][read_abunmatch['M200']> 1e9]/read_abunmatch['M200'][read_abunmatch['M200']> 1e9],read_abunmatch['Mstar_high'][read_abunmatch['M200']> 1e9]/read_abunmatch['M200'][read_abunmatch['M200']> 1e9],color = 'grey', alpha = 0.5)
    ax3.scatter(objs_pd_comb['Mpeak'][objs_pd_comb['type']=='Central'],objs_pd_comb['Mstar_Mpeak'][objs_pd_comb['type']=='Central'] ,edgecolor = 'k',facecolor = 'none', s = markersize*1, linewidths = edgewidth)    
    ax3.scatter(objs_pd_comb['Mpeak'][objs_pd_comb['type']=='Central'],objs_pd_comb['Mstar_Mpeak'][objs_pd_comb['type']=='Central'],c = np.log10(np.array(objs_pd_comb['mHI'][objs_pd_comb['type']=='Central'].tolist())), cmap = cmx, norm = cNorm,edgecolor = 'k', s = markersize*1, linewidths = edgewidth)
    ax3.scatter(objs_pd_comb['Mpeak'][objs_pd_comb['type']=='Satellite'],objs_pd_comb['Mstar_Mpeak'][objs_pd_comb['type']=='Satellite'] ,edgecolor = 'k',facecolor = 'none', marker = '*', s = markersize*1.5, linewidths = edgewidth)    
    ax3.scatter(objs_pd_comb['Mpeak'][objs_pd_comb['type']=='Satellite'],objs_pd_comb['Mstar_Mpeak'][objs_pd_comb['type']=='Satellite'],c = np.log10(np.array(objs_pd_comb['mHI'][objs_pd_comb['type']=='Satellite'].tolist())), cmap = cmx, norm = cNorm,edgecolor = 'k', marker = '*', s = markersize*1.5, linewidths = edgewidth)
    #ax3.scatter(readdata['M200']*1e10,readdata['M_*']*1e7,marker = '+',c = 'k')
    ax3.set_xscale('log')
    ax3.set_yscale('log')
    ax3.set_ylabel(r'M$_*$/M$_\odot$')
    ...
    ax4.scatter(objs_pd_comb['mass'][objs_pd_comb['type']=='Central'],objs_pd_comb['Mstar_Mpeak'][objs_pd_comb['type']=='Central'],c = objs_pd_comb['mHI'][objs_pd_comb['type']=='Central']/(objs_pd_comb['Mstar_Mpeak'][objs_pd_comb['type']=='Central'] + objs_pd_comb['mHI'][objs_pd_comb['type']=='Central']), cmap = cmx, norm = cNorm,edgecolor = 'k', s = markersize*1, linewidths = edgewidth)
    ax4.scatter(objs_pd_comb['mass'][objs_pd_comb['type']=='Satellite'],objs_pd_comb['Mstar_Mpeak'][objs_pd_comb['type']=='Satellite'],c = objs_pd_comb['mHI'][objs_pd_comb['type']=='Satellite']/(objs_pd_comb['Mstar_Mpeak'][objs_pd_comb['type']=='Satellite'] + objs_pd_comb['mHI'][objs_pd_comb['type']=='Satellite']), cmap = cmx, norm = cNorm,edgecolor = 'k', marker = '*', s = markersize*1.5, linewidths = edgewidth)
    ...
    ax4.legend([cen_v_tau90,sat_v_tau90],['Central','Satellite'],scatterpoints = 1,facecolor = 'white',loc = 0,framealpha = 0,frameon = False)
    ...
    cNorm  = colors.Normalize(vmin=1.5, vmax = 4)    
    ax5.scatter(objs_pd_comb['mass'][objs_pd_comb['type']=='Satellite'],(objs_pd_comb['Mstar_Mpeak'][objs_pd_comb['type']=='Satellite'] + objs_pd_comb['mHI'][objs_pd_comb['type']=='Satellite']),c = np.log10(objs_pd_comb['massiveDist'][objs_pd_comb['type']=='Satellite']), cmap = cmx, norm = cNorm,edgecolor = 'k', marker = '*', s = markersize*1.5, linewidths = edgewidth)
    ax5.scatter(objs_pd_comb['mass'][objs_pd_comb['type']=='Central'],(objs_pd_comb['Mstar_Mpeak'][objs_pd_comb['type']=='Central'] + objs_pd_comb['mHI'][objs_pd_comb['type']=='Central']),c = np.log10(objs_pd_comb['massiveDist'][objs_pd_comb['type']=='Central']), cmap = cmx, norm = cNorm,edgecolor = 'k', s = markersize*1, linewidths = edgewidth)
    ...
    ax5sub = fig5.add_subplot(gs[1])
    cNorm  = colors.Normalize(vmin=1.5, vmax = 4)    
    ax5.scatter(objs_pd_comb['Mpeak'][objs_pd_comb['type']=='Central'],(objs_pd_comb['Mstar_Mpeak'][objs_pd_comb['type']=='Central'] + objs_pd_comb['mHI'][objs_pd_comb['type']=='Central']),c = np.log10(objs_pd_comb['massiveDist'][objs_pd_comb['type']=='Central']), cmap = cmx, norm = cNorm,edgecolor = 'k', s = markersize*1, linewidths = edgewidth)
    ax5.scatter(objs_pd_comb['Mpeak'][objs_pd_comb['type']=='Satellite'],(objs_pd_comb['Mstar_Mpeak'][objs_pd_comb['type']=='Satellite'] + objs_pd_comb['mHI'][objs_pd_comb['type']=='Satellite']),c = np.log10(objs_pd_comb['massiveDist'][objs_pd_comb['type']=='Satellite']), cmap = cmx, norm = cNorm,edgecolor = 'k', marker="*", s = markersize*1.5, linewidths = edgewidth)
    #ax5.scatter(readdata['M200']*1e10,readdata['M_*']*1e7,marker = '+',c = 'k')
    ax5.set_xscale('log')
    ax5.set_yscale('log')
    ax5.set_ylabel(r'M$_*$ + M$_{\mathrm{HI}}$ [M$_\odot$]')
    ...
    #Stellar mass fraction of satellites
    fstar = ax6.scatter(objs_pd_comb['massiveDist'][objs_pd_comb['type']=='Satellite'],objs_pd_comb['M_star'][objs_pd_comb['type']=='Satellite']/objs_pd_comb['Mpeak'][objs_pd_comb['type']=='Satellite'],edgecolor = 'red',facecolor = 'none', marker = '*', s = ((objs_pd_comb['Mpeak'][objs_pd_comb['type']=='Central'])**0.33/10*ms_scale*1.5).tolist(), linewidths = edgewidth)
    #ax6.scatter(readdata['M200']*1e10,readdata['M_*']*1e7,marker = '+',c = 'k')
    ax6.set_xscale('log')
    ax6.set_yscale('log')
