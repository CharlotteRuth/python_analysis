...
#Run with
#%run /home/christensen/Code/python/python_analysis/metalradiihist_all.py
...
if __name__ == '__main__':
    ...
    for i in reversed(range(0,len(dirs))):
        ...
        data = np.loadtxt(outfilebase + '_rhistz_all.txt')
