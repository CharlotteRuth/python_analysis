...
cptmarvel_plt = plt.scatter(np.array(objs_pd_cm['mstar']),np.array(objs_pd_cm['SFR'])/np.array(objs_pd_cm['mstar']),marker = markers[0], label = 'Cpt. Marvel' ,zorder = 2,c = colors_cm, cmap = colormap, norm=cNorm)
rogue_plt = plt.scatter(np.array(objs_pd_r['mstar']),np.array(objs_pd_r['SFR'])/np.array(objs_pd_r['mstar']),marker = markers[1],zorder = 3,c = colors_r, cmap = colormap, norm=cNorm)
elektra_plt = plt.scatter(np.array(objs_pd_e['mstar']),np.array(objs_pd_e['SFR'])/np.array(objs_pd_e['mstar']),marker = markers[2],zorder = 4,c = colors_e, cmap = colormap, norm=cNorm)
storm_plt = plt.scatter(np.array(objs_pd_s['mstar']),np.array(objs_pd_s['SFR'])/np.array(objs_pd_s['mstar']),marker = markers[3],zorder = 5,c = colors_s, cmap = colormap, norm=cNorm)
sandra_plt = plt.scatter(np.array(objs_pd_sandra['mstar']),np.array(objs_pd_sandra['SFR'])/np.array(objs_pd_sandra['mstar']),marker = markers[4],zorder = 5,c = colors_sandra, cmap = colormap, norm=cNorm)
ruth_plt = plt.scatter(np.array(objs_pd_ruth['mstar']),np.array(objs_pd_ruth['SFR'])/np.array(objs_pd_ruth['mstar']),marker = markers[5],zorder = 5,c = colors_ruth, cmap = colormap, norm=cNorm)
sonia_plt = plt.scatter(np.array(objs_pd_sonia['mstar']),np.array(objs_pd_sonia['SFR'])/np.array(objs_pd_sonia['mstar']),marker = markers[6],zorder = 5,c = colors_sonia, cmap = colormap, norm=cNorm)
elena_plt = plt.scatter(np.array(objs_pd_elena['mstar']),np.array(objs_pd_elena['SFR'])/np.array(objs_pd_elena['mstar']),marker = markers[7],zorder = 5,c = colors_elena, cmap = colormap, norm=cNorm)
plt.xlabel(r'M$_*$/M$_\odot$')
plt.ylabel(r'SSFR [yr$^{-1}$]')
plt.xscale('log')
plt.yscale('log')
#plt.axis([1e4, 3e9, 1e-12, 1e-9])
...
#
plt.figure(1)
plt.scatter(np.array(objs_pd_cm['mstar']),np.array(objs_pd_cm['r_half']),marker = markers[0], label = 'Cpt. Marvel' ,zorder = 2,c = colors_cm, cmap = colormap, norm=cNorm)
plt.scatter(np.array(objs_pd_r['mstar']),np.array(objs_pd_r['r_half']),marker = markers[1], label = 'Rogue', zorder = 3,c = colors_r, cmap = colormap, norm=cNorm)
plt.scatter(np.array(objs_pd_e['mstar']),np.array(objs_pd_e['r_half']),marker = markers[2], label = 'Elektra',zorder = 4,c = colors_e, cmap = colormap, norm=cNorm)
plt.scatter(np.array(objs_pd_s['mstar']),np.array(objs_pd_s['r_half']),marker = markers[3], label = 'Storm', zorder = 5,c = colors_s, cmap = colormap, norm=cNorm)
plt.scatter(np.array(objs_pd_sandra['mstar']),np.array(objs_pd_sandra['r_half']),marker = markers[4], label = 'Sandra', zorder = 5,c = colors_sandra, cmap = colormap, norm=cNorm)
plt.scatter(np.array(objs_pd_ruth['mstar']),np.array(objs_pd_ruth['r_half']),marker = markers[5], label = 'Ruth', zorder = 5,c = colors_ruth, cmap = colormap, norm=cNorm)
plt.scatter(np.array(objs_pd_sonia['mstar']),np.array(objs_pd_sonia['r_half']),marker = markers[6], label = 'Sonia', zorder = 5,c = colors_sonia, cmap = colormap, norm=cNorm)
plt.scatter(np.array(objs_pd_elena['mstar']),np.array(objs_pd_elena['r_half']),marker = markers[7], label = 'Elena', zorder = 5,c = colors_elena, cmap = colormap, norm=cNorm)
plt.xlabel(r'M$_*$/M$_\odot$')
...
plt.legend([mcquinn_plt, cptmarvel_plt, rogue_plt, elektra_plt, storm_plt, sandra_plt, ruth_plt, sonia_plt, elena_plt],['McQuinn+ 2015','Cpt. Marvel','Rogue','Elektra','Storm','Sandra','Ruth','Sonia','Elena'],loc=4)
plt.show()
plt.savefig(outbase + '.size_mstar.png')
plt.clf()
...
plt.legend([mcquinn_plt, cptmarvel_plt, rogue_plt, elektra_plt, storm_plt, sandra_plt, ruth_plt, sonia_plt, elena_plt],['McQuinn+ 2015','Cpt. Marvel','Rogue','Elektra','Storm','Sandra','Ruth','Sonia','Elena'],loc=2)
plt.show()
plt.savefig(outbase + '.sigma_mstar.png')
plt.clf()
...
plt.scatter(np.array(objs_pd_cm['LogL_V'].values),np.array(objs_pd_cm['FeH_mean']),marker = markers[0], label = 'Cpt. Marvel',zorder = 2,c = colors_cm, cmap = colormap, norm=cNorm)
plt.scatter(np.array(objs_pd_r['LogL_V']),np.array(objs_pd_r['FeH_mean']),marker = markers[1], label = 'Rogue', zorder = 3,c = colors_r, cmap = colormap, norm=cNorm)
plt.scatter(np.array(objs_pd_e['LogL_V']),np.array(objs_pd_e['FeH_mean']),marker = markers[2], label = 'Elektra',zorder = 4,c = colors_e, cmap = colormap, norm=cNorm)
plt.scatter(np.array(objs_pd_s['LogL_V']),np.array(objs_pd_s['FeH_mean']),marker = markers[3], label = 'Storm', zorder = 5,c = colors_s, cmap = colormap, norm=cNorm)
plt.scatter(np.array(objs_pd_sandra['LogL_V']),np.array(objs_pd_sandra['FeH_mean']),marker = markers[4], label = 'Sandra', zorder = 5,c = colors_sandra, cmap = colormap, norm=cNorm)
plt.scatter(np.array(objs_pd_ruth['LogL_V']),np.array(objs_pd_ruth['FeH_mean']),marker = markers[5], label = 'Ruth', zorder = 5,c = colors_ruth, cmap = colormap, norm=cNorm)
plt.scatter(np.array(objs_pd_sonia['LogL_V']),np.array(objs_pd_sonia['FeH_mean']),marker = markers[6], label = 'Sonia', zorder = 5,c = colors_sonia, cmap = colormap, norm=cNorm)
plt.scatter(np.array(objs_pd_elena['LogL_V']),np.array(objs_pd_elena['FeH_mean']),marker = markers[7], label = 'Elena', zorder = 5,c = colors_elena, cmap = colormap, norm=cNorm)
...
#kirbydata.plot(x = 'LogL_V',y = 'LogFe',yerr = 'LogFe_err',xerr = 'LogL_V_err',fmt="o",color = "grey")
kirby_plt = plt.errorbar((kirbydata['LogL_V']).tolist(),kirbydata['LogFe'].tolist(),yerr = kirbydata['LogFe_err'].tolist(),xerr = kirbydata['LogL_V_err'].tolist(),color = "grey",fmt="o",zorder = 1)
cptmarvel_plt = plt.scatter(np.array(objs_pd_cm['LogL_V'].values),np.array(objs_pd_cm['Zstellar_mean']),marker = markers[0], label = 'Cpt. Marvel',zorder = 2,c = colors_cm, cmap = colormap, norm=cNorm)
rogue_plt = plt.scatter(np.array(objs_pd_r['LogL_V'].values),np.array(objs_pd_r['Zstellar_mean']),marker = markers[1], label = 'Rogue', zorder = 3,c = colors_r, cmap = colormap, norm=cNorm)
elektra_plt = plt.scatter(np.array(objs_pd_e['LogL_V'].values),np.array(objs_pd_e['Zstellar_mean']),marker = markers[2], label = 'Elektra',zorder = 4,c = colors_e, cmap = colormap, norm=cNorm)
storm_plt = plt.scatter(np.array(objs_pd_s['LogL_V'].values),np.array(objs_pd_s['Zstellar_mean']),marker = markers[3], label = 'Storm', zorder = 5,c = colors_s, cmap = colormap, norm=cNorm)
sandra_plt = plt.scatter(np.array(objs_pd_sandra['LogL_V'].values),np.array(objs_pd_sandra['Zstellar_mean']),marker = markers[4], label = 'Sandra', zorder = 5,c = colors_sandra, cmap = colormap, norm=cNorm)
plt.scatter(np.array(objs_pd_ruth['LogL_V']),np.array(objs_pd_ruth['Zstellar_mean']),marker = markers[5], label = 'Ruth', zorder = 5,c = colors_ruth, cmap = colormap, norm=cNorm)
plt.scatter(np.array(objs_pd_sonia['LogL_V']),np.array(objs_pd_sonia['Zstellar_mean']),marker = markers[6], label = 'Sonia', zorder = 5,c = colors_sonia, cmap = colormap, norm=cNorm)
plt.scatter(np.array(objs_pd_elena['LogL_V']),np.array(objs_pd_elena['Zstellar_mean']),marker = markers[7], label = 'Elena', zorder = 5,c = colors_elena, cmap = colormap, norm=cNorm)
plt.xlabel(r'L$_V$/L$_{V,solar}$')
...
plt.figure(1)
plt.scatter(np.array(objs_pd_cm['mstar'])[np.where(objs_pd_cm['oxh_sfr'] != 0)],np.array(objs_pd_cm['oxh_sfr'])[np.where(objs_pd_cm['oxh_sfr'] != 0)] + 12,marker = markers[0], label = 'Cpt. Marvel',zorder = 2,c = colors_cm[np.where(objs_pd_cm['oxh_sfr'] != 0)], cmap = colormap, norm=cNorm)
plt.scatter(np.array(objs_pd_r['mstar'])[np.where(objs_pd_r['oxh_sfr'] != 0)],np.array(objs_pd_r['oxh_sfr'] + 12)[np.where(objs_pd_r['oxh_sfr'] != 0)],marker = markers[1], label = 'Rogue', zorder = 3,c = colors_r[np.where(objs_pd_r['oxh_sfr'] != 0)], cmap = colormap, norm=cNorm)
plt.scatter(np.array(objs_pd_e['mstar'])[np.where(objs_pd_e['oxh_sfr'] != 0)],np.array(objs_pd_e['oxh_sfr'] + 12)[np.where(objs_pd_e['oxh_sfr'] != 0)],marker = markers[2], label = 'Elektra',zorder = 4,c = colors_e[np.where(objs_pd_e['oxh_sfr'] != 0)], cmap = colormap, norm=cNorm)
plt.scatter(np.array(objs_pd_s['mstar'])[np.where(objs_pd_s['oxh_sfr'] != 0)],np.array(objs_pd_s['oxh_sfr'] + 12)[np.where(objs_pd_s['oxh_sfr'] != 0)],marker = markers[3], label = 'Storm', zorder = 5,c = colors_s[np.where(objs_pd_s['oxh_sfr'] != 0)], cmap = colormap, norm=cNorm)
...
plt.xscale('log')
plt.axis([3e5, 1e12, 6.7, 9.5])
plt.show()
plt.savefig(outbase + '.mzr_sfe.png')
plt.clf()

plt.figure(1)
plt.scatter(np.array(objs_pd_cm['mstar'])[np.where(objs_pd_cm['oxh_cold'] != 0)],np.array(objs_pd_cm['oxh_cold'])[np.where(objs_pd_cm['oxh_cold'] != 0)] + 12,marker = markers[0], label = 'Cpt. Marvel',zorder = 2,c = colors_cm[np.where(objs_pd_cm['oxh_cold'] != 0)], cmap = colormap, norm=cNorm)
